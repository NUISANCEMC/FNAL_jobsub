...
class NuisMinJob:
    ...
    def __init__(self, args, nuisargs):
        ...
        self.UID = "__NUISMIN-" + self.Tag + "-" + date.now().strftime('%Y%m%d%H%M%S') + "-" + str(os.getpid())
    ...
    def MakeScript(self):
        ...
        script.write("nuismin " + self.Arguments + "\n")
...
# To do,
# - move this into NuisMinJob class file
