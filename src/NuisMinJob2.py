...
class NuisMinJob2:
    ...
    def GetArguments(self):
        ...
        parser = CreateParser( "NUISANCE nuismin Handler @ FERMILAB",
                               "nuisance_jobsub --job nuismin <options>",
                               "nuismin" )

        required=parser.add_argument_group ("required nuismin arguments")
        ...
        optional=parser.add_argument_group ("optional nuismin arguments")
    ...
    def MakeScript(self):
        ...
        script.write("nuismin " + self.Arguments + " >> " + self.LogFile + " 2>&1 \n")
