...
class NuisSystJob2:
    ...
    def GetArguments(self):
        ...
        parser = CreateParser( "NUISANCE nuissyst Handler @ FERMILAB",
                               "nuisance_jobsub --job nuissyst <options>",
                               "nuissyst" )

        required=parser.add_argument_group ("required nuissyst arguments")
        ...
        optional=parser.add_argument_group ("optional nuissyst arguments")
    ...
    def __init__(self, args, nuisargs):
        ...
        # Setup the main arguments for nuissyst
    ...
    def MakeScript(self):
        ...
        script.write("nuissyst " + self.Arguments + " >> " + self.LogFile + " 2>&1 \n")
